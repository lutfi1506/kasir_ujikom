            ...
            <div class="flex justify-between">
                ...
                <form class="flex items-center gap-2" action="{{ route('laporan') }}">
                    <input type="month" name="month" class="input input-bordered w-32 sm:w-64"
                        value="{{ $month }}">
                    {{-- <input type="text" name="month" class="input input-bordered w-32 sm:w-64"> --}}
                    <button type="submit" class="btn btn-square">
                        <svg class="w-5 h-5 text-gray-500" viewBox="0 0 24 24" fill="none">
                            <path d=" M21 21L15 15M17 10C17 13.866 13.866 17 10 17C6.13401 17 3 13.866 3 10C3 6.13401
                        6.13401 3 10 3C13.866 3 17 6.13401 17 10Z" stroke="currentColor" stroke-width="2"
